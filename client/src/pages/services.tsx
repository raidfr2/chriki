...
export default function Services() {
  ...
  const exportData = () => {
    ...
    a.href = url;
    a.download = `chriki-services-data-${new Date().toISOString().split('T')[0]}.json`;
      ...
      <header className="bg-background border-b-2 border-foreground px-4 py-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="font-mono text-3xl font-bold tracking-tight dot-matrix">SERVICES.GUIDE</h1>
                ...
                <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                  <DialogHeader>
                    <DialogTitle className="font-mono">
                      {editingDocument ? 'EDIT SERVICE' : 'ADD NEW SERVICE'}
                    </DialogTitle>
                    <DialogDescription>
                      Create or edit administrative service information
                    </DialogDescription>
                  </DialogHeader>
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between">
            <h2 className="font-mono text-xl font-bold">
              SERVICES ({filteredDocuments.length})
            </h2>
          </div>
        </div>
