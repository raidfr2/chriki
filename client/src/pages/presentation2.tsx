...
const translations = {
  en: {
    ...
    sections: {
      ...
      realTimeBuses: "الحافلات.الفورية",
      ...
      environmentalDesc: "Reducing Algeria's carbon footprint through smart public transport adoption",
      carbonFootprint: "تقليل.البصمة.الكربونية",
      yassirComparison: "مقارنة.تأثير.ياسير",
      yassirComparisonDesc: "Yassir had 6 million users in 2024. If just 1% switched to public transport through CHRIKI's guidance, we could save significant CO2 emissions.",
      carbonSavings: "توفير.الكربون.المحتمل",
      dailyTrips: "60,000 daily car trips avoided",
      annualSavings: "~13,140 tons CO2 saved annually",
      equivalentTrees: "Equivalent to planting 591,300 trees",
      algeriaGreen: "مستقبل.الجزائر.الأخضر",
      algeriaGreenDesc: "Supporting Algeria's commitment to environmental sustainability and the Paris Climate Agreement",
  ...
  fr: {
    ...
    sections: {
      ...
      metroIntegrationDesc: "Navigation métro transparente avec points de transfert et infos d'accessibilité",
      
      // Impact environnemental
      environmentalImpact: "IMPACT.ENVIRONNEMENTAL",
      environmentalDesc: "Réduire l'empreinte carbone de l'Algérie grâce à l'adoption intelligente des transports publics",
      carbonFootprint: "RÉDUCTION.EMPREINTE.CARBONE",
      yassirComparison: "COMPARAISON.IMPACT.YASSIR",
      yassirComparisonDesc: "Yassir avait 6 millions d'utilisateurs en 2024. Si seulement 1% passait aux transports publics grâce aux conseils de CHRIKI, nous pourrions économiser des émissions de CO2 significatives.",
      carbonSavings: "ÉCONOMIES.CARBONE.POTENTIELLES",
      dailyTrips: "60 000 trajets en voiture évités quotidiennement",
      annualSavings: "~13 140 tonnes de CO2 économisées annuellement",
      equivalentTrees: "Équivalent à planter 591 300 arbres",
      algeriaGreen: "ALGÉRIE.VERTE.FUTURE",
      algeriaGreenDesc: "Soutenir l'engagement de l'Algérie envers la durabilité environnementale et l'Accord de Paris sur le climat",
      
      documentSearch: "DÉMO.RECHERCHE.DOCUMENTS",
      documentDesc: "Voyez comment CHRIKI aide les citoyens à trouver instantanément les exigences documentaires",
  ...
  ar: {
    ...
    sections: {
      ...
      environmentalDesc: "تقليل البصمة الكربونية للجزائر من خلال اعتماد ذكي لوسائل النقل العام",
      carbonFootprint: "تقليل.البصمة.الكربونية",
      yassirComparison: "مقارنة.تأثير.ياسير",
      yassirComparisonDesc: "كان لدى ياسير 6 ملايين مستخدم في 2024. إذا تحول 1% فقط إلى وسائل النقل العام من خلال إرشادات شريكي، يمكننا توفير انبعاثات CO2 كبيرة.",
      carbonSavings: "توفير.الكربون.المحتمل",
      dailyTrips: "60,000 رحلة سيارة يومية يتم تجنبها",
      annualSavings: "~13,140 طن CO2 يتم توفيرها سنوياً",
      equivalentTrees: "يعادل زراعة 591,300 شجرة",
      algeriaGreen: "الجزائر.الخضراء.المستقبل",
      algeriaGreenDesc: "دعم التزام الجزائر بالاستدامة البيئية واتفاقية باريس للمناخ",
...
Kamlin fi Medina Jdida, qrib men Place d'Armes!
      ...
      <div className="mt-20 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 border-2 border-green-200 dark:border-green-800 rounded-lg p-8">
        <div className="text-center mb-8">
          <h3 className="font-mono text-2xl font-bold mb-4 text-green-800 dark:text-green-400">{t.sections.environmentalImpact}</h3>
          <p className="text-green-700 dark:text-green-300 text-lg max-w-3xl mx-auto">
            {t.sections.environmentalDesc}
          </p>
        </div>

        <div className="grid lg:grid-cols-2 gap-8 items-center">
          {/* Yassir Comparison */}
          <div className="bg-white dark:bg-gray-900 border border-green-200 dark:border-green-700 rounded-lg p-6">
            <h4 className="font-mono text-lg font-bold mb-4 text-green-800 dark:text-green-400">{t.sections.yassirComparison}</h4>
            <p className="text-green-700 dark:text-green-300 mb-6 leading-relaxed">
              {t.sections.yassirComparisonDesc}
            </p>
            
            <div className="space-y-4">
              <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg p-4">
                <h5 className="font-mono text-sm font-bold mb-3 text-green-800 dark:text-green-400">{t.sections.carbonSavings}</h5>
                <div className="space-y-2 text-sm">
                  <div className="flex items-center gap-2">
                    <span className="text-2xl">🚗</span>
                    <span className="text-green-700 dark:text-green-300">{t.sections.dailyTrips}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-2xl">🌍</span>
                    <span className="text-green-700 dark:text-green-300">{t.sections.annualSavings}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-2xl">🌳</span>
                    <span className="text-green-700 dark:text-green-300">{t.sections.equivalentTrees}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Algeria Green Future */}
          <div className="text-center">
            <div className="text-6xl mb-4">🇩🇿</div>
            <h4 className="font-mono text-xl font-bold mb-4 text-green-800 dark:text-green-400">{t.sections.algeriaGreen}</h4>
            <p className="text-green-700 dark:text-green-300 leading-relaxed">
              {t.sections.algeriaGreenDesc}
            </p>
            
            <div className="mt-6 grid grid-cols-2 gap-4">
              <div className="bg-white dark:bg-gray-900 border border-green-200 dark:border-green-700 rounded-lg p-4">
                <div className="text-2xl mb-2">🚌</div>
                <div className="text-xs font-mono text-green-800 dark:text-green-400">PUBLIC TRANSPORT</div>
                <div className="text-sm text-green-700 dark:text-green-300">Reduced emissions</div>
              </div>
              <div className="bg-white dark:bg-gray-900 border border-green-200 dark:border-green-700 rounded-lg p-4">
                <div className="text-2xl mb-2">♻️</div>
                <div className="text-xs font-mono text-green-800 dark:text-green-400">SUSTAINABILITY</div>
                <div className="text-sm text-green-700 dark:text-green-300">Green future</div>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Impact Statistics */}
        <div className="mt-8 bg-white dark:bg-gray-900 border border-green-200 dark:border-green-700 rounded-lg p-6">
          <h5 className="font-mono text-center text-lg font-bold mb-6 text-green-800 dark:text-green-400">POTENTIAL ENVIRONMENTAL IMPACT</h5>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div>
              <div className="text-3xl font-bold text-green-600 dark:text-green-400">60K</div>
              <div className="text-sm text-green-700 dark:text-green-300">Daily car trips avoided</div>
              <div className="text-xs text-muted-foreground">With just 1% adoption</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-green-600 dark:text-green-400">13,140</div>
              <div className="text-sm text-green-700 dark:text-green-300">Tons CO2 saved annually</div>
              <div className="text-xs text-muted-foreground">Environmental benefit</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-green-600 dark:text-green-400">591K</div>
              <div className="text-sm text-green-700 dark:text-green-300">Trees equivalent planted</div>
              <div className="text-xs text-muted-foreground">Carbon offset impact</div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-16">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="font-mono text-2xl font-bold">HEALTHY COOKING & NUTRITION</h3>
                </div>
                <p className="text-lg text-muted-foreground mb-6">
                  Transform your available ingredients into nutritious, delicious meals. Get healthy Algerian recipes, nutritional guidance, meal planning advice, and learn to cook balanced meals that fuel your body and mind.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-green-500 rounded-full mr-3"></span>
                    <strong>Nutritious recipes with available ingredients</strong>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-green-500 rounded-full mr-3"></span>
                    <strong>Healthy Algerian dishes and low-calorie alternatives</strong>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-green-500 rounded-full mr-3"></span>
                    <strong>Meal planning for weight management and health goals</strong>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-green-500 rounded-full mr-3"></span>
                    <strong>Nutritional information and dietary guidance</strong>
                  </div>
                </div>
              </div>
              <div className="bg-muted border-2 border-foreground rounded-lg overflow-hidden">
                <div className="bg-green-600 text-white p-3 font-mono font-bold text-sm">
                  شريكي CHRIKI - Healthy Nutrition Assistant
                </div>
                <div className="p-4 space-y-3">
                  <div className="flex justify-end">
                    <div className="bg-green-600 text-white p-3 rounded-lg max-w-xs shadow-md">
                      <div className="text-sm font-medium" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif', lineHeight: '1.5'}}>
                        بغيت نخسر الوزن، عندي طماطم وبصل وبيض، واش نطبخ صحي؟
                      </div>
                    </div>
                  </div>
                  <div className="flex justify-start">
                    <div className="bg-background border border-green-200 p-3 rounded-lg max-w-xs shadow-md">
                      <div className="text-sm space-y-2">
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-green-600">شكشوكة صحية:</strong> <span className="text-foreground/80">استعملي ملعقة صغيرة زيت زيتون فقط، زيدي الفلفل الأخضر والسبانخ. البيض غني بالبروتين (70 سعرة/بيضة)</span></div>
                        </div>
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-green-600">سلطة البيض المسلوق:</strong> <span className="text-foreground/80">اسلقي البيض، قطعي الطماطم والبصل، زيدي خس وخيار. صوص: ليمون + ملح + فلفل أسود</span></div>
                        </div>
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-green-600">نصيحة غذائية:</strong> <span className="text-foreground/80">الطماطم غنية بالليكوبين (مضاد أكسدة)، البصل يحرق الدهون، البيض يشبعك لفترة طويلة</span></div>
                        </div>
                        <div className="bg-green-50 dark:bg-green-950/20 p-2 rounded text-center mt-3">
                          <div className="text-xs text-green-700 dark:text-green-300 font-bold" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                            🥗 السعرات: ~200 كالوري | البروتين: 18غ | الألياف: 4غ
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex justify-end">
                    <div className="bg-green-600 text-white p-3 rounded-lg max-w-xs shadow-md">
                      <div className="text-sm font-medium" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif', lineHeight: '1.5'}}>
                        واش من الخضار خاصني نزيد باش نحس بالشبع؟
                      </div>
                    </div>
                  </div>
                  <div className="flex justify-start">
                    <div className="bg-background border border-green-200 p-3 rounded-lg max-w-xs shadow-md">
                      <div className="text-sm space-y-2">
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-green-600">خضار عالية الألياف:</strong> <span className="text-foreground/80">الكوسا، الباذنجان، الجزر، البروكلي. تملأ المعدة بسعرات قليلة</span></div>
                        </div>
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-green-600">ورقيات خضراء:</strong> <span className="text-foreground/80">السبانخ، الجرجير، الخس. غنية بالحديد والفيتامينات، سعرات قليلة جداً</span></div>
                        </div>
                        <div className="text-muted-foreground text-center mt-3 pt-2 border-t border-green-200" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          💚 نصف الطبق خضار + ربع بروتين + ربع نشويات = وجبة متوازنة
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="lg:order-2">
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  Get reliable health guidance for everyday symptoms, wellness questions, and harm reduction support. Understand when to rest, when to see a doctor, and how to stay safe while maintaining good health habits.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center text-sm">
                  ...
                  <div className="flex items-center text-sm">
                    ...
                    <strong>Harm reduction guidance and safety information</strong>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-red-500 rounded-full mr-3"></span>
                    <strong>Crisis intervention and emergency resources</strong>
                  </div>
                </div>
              </div>
            </div>

            {/* 2.5. Harm Reduction & Crisis Support - Left Description, Right Demo */}
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-4">
                  <div className="text-4xl mr-4">🛡️</div>
                  <h3 className="font-mono text-2xl font-bold">HARM REDUCTION & CRISIS SUPPORT</h3>
                </div>
                <p className="text-lg text-muted-foreground mb-6">
                  Get confidential, non-judgmental support for sensitive situations. Access harm reduction information, crisis intervention resources, and safety guidance when you need it most.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-red-500 rounded-full mr-3"></span>
                    <strong>Substance use harm reduction strategies</strong>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-red-500 rounded-full mr-3"></span>
                    <strong>Mental health crisis intervention</strong>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-red-500 rounded-full mr-3"></span>
                    <strong>Emergency contacts and local resources</strong>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-red-500 rounded-full mr-3"></span>
                    <strong>Safety planning and risk assessment</strong>
                  </div>
                </div>
                <div className="mt-4 p-3 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg">
                  <p className="text-xs text-red-700 dark:text-red-300">
                    <strong>Confidential & Non-judgmental:</strong> All conversations are private and focused on your safety and wellbeing.
                  </p>
                </div>
              </div>
              <div className="bg-muted border-2 border-red-500 rounded-lg overflow-hidden">
                <div className="bg-red-600 text-white p-3 font-mono font-bold text-sm">
                  شريكي CHRIKI - Crisis Support (Confidential)
                </div>
                <div className="p-4 space-y-3">
                  <div className="flex justify-end">
                    <div className="bg-red-600 text-white p-3 rounded-lg max-w-xs shadow-md">
                      <div className="text-sm font-medium" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif', lineHeight: '1.5'}}>
                        حاسس بضغط كبير وبغيت نشرب، واش نعمل؟
                      </div>
                    </div>
                  </div>
                  <div className="flex justify-start">
                    <div className="bg-background border border-red-200 p-3 rounded-lg max-w-xs shadow-md">
                      <div className="text-sm space-y-2">
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-red-600">أولاً، إنت شجاع:</strong> <span className="text-foreground/80">طلب المساعدة قوة مش ضعف. هذا الشعور راح يعدي</span></div>
                        </div>
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-red-600">تقنية 5-4-3-2-1:</strong> <span className="text-foreground/80">5 حاجات تشوفها، 4 تلمسها، 3 تسمعها، 2 تشمها، 1 تذوقها. يهدي القلق</span></div>
                        </div>
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-red-600">اتصل بصديق:</strong> <span className="text-foreground/80">أو خط المساعدة 3033 (مجاني 24/7). ما تبقاش وحدك في هذا الوقت</span></div>
                        </div>
                        <div className="bg-red-50 dark:bg-red-950/20 p-2 rounded text-center mt-3">
                          <div className="text-xs text-red-700 dark:text-red-300 font-bold">
                            🚨 خط الطوارئ: 14 | خط الدعم النفسي: 3033
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex justify-start">
                    <div className="bg-background border border-red-200 p-3 rounded-lg max-w-xs shadow-md">
                      <div className="text-sm space-y-2">
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-red-600">مراكز الصحة النفسية:</strong> <span className="text-foreground/80">مستشفى فرانز فانون، مركز الصحة النفسية بالجزائر العاصمة</span></div>
                        </div>
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-red-600">جمعيات الدعم:</strong> <span className="text-foreground/80">جمعية الأمل للصحة النفسية، مجموعات الدعم المحلية</span></div>
                        </div>
                        <div className="text-muted-foreground text-center mt-3 pt-2 border-t border-red-200" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          إنت مش وحدك. المساعدة متوفرة والتعافي ممكن 💙
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            {/* 2.7. Environmental Awareness & Waste Management - Right Description, Left Demo */}
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="bg-muted border-2 border-green-600 rounded-lg overflow-hidden lg:order-1">
                <div className="bg-green-600 text-white p-3 font-mono font-bold text-sm">
                  شريكي CHRIKI - Environmental Assistant
                </div>
                <div className="p-4 space-y-3">
                  <div className="flex justify-end">
                    <div className="bg-green-600 text-white p-3 rounded-lg max-w-xs shadow-md">
                      <div className="text-sm font-medium" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif', lineHeight: '1.5'}}>
                        كيفاش نتخلص من عقب السجاير بطريقة صحيحة؟
                      </div>
                    </div>
                  </div>
                  <div className="flex justify-start">
                    <div className="bg-background border border-green-200 p-3 rounded-lg max-w-xs shadow-md">
                      <div className="text-sm space-y-2">
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-green-600">مخلفات السجاير (العقب) تلوث البيئة بشدة. هنا الحلول:</strong></div>
                        </div>
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-green-600">جمع العقب:</strong> <span className="text-foreground/80">استعملي علبة معدنية صغيرة (مثل علبة النعناع) لحفظ العقب بدل رميها في الشارع</span></div>
                        </div>
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-green-600">إعادة التدوير:</strong> <span className="text-foreground/80">مراكز إعادة تدوير في الجزائر العاصمة (مثل EcoJazair) تقبل مخلفات السجاير. زوري موقعهم ecojazair.dz</span></div>
                        </div>
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-green-600">نصيحة بيئية:</strong> <span className="text-foreground/80">التدخين يضر بالبيئة. جربي بدائل مثل السجاير الإلكترونية أو منتجات النيكوتين المسخنة باش تقللي العقب</span></div>
                        </div>
                        <div className="bg-green-50 dark:bg-green-950/20 p-2 rounded text-center mt-3">
                          <div className="text-xs text-green-700 dark:text-green-300 font-bold" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                            🌿 خلي الجزائر نظيفة! كل عقبة سيجارة تحتاج 12 سنة باش تتحلل
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex justify-end">
                    <div className="bg-green-600 text-white p-3 rounded-lg max-w-xs shadow-md">
                      <div className="text-sm font-medium" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif', lineHeight: '1.5'}}>
                        واش كاين مراكز أخرى لإعادة التدوير؟
                      </div>
                    </div>
                  </div>
                  <div className="flex justify-start">
                    <div className="bg-background border border-green-200 p-3 rounded-lg max-w-xs shadow-md">
                      <div className="text-sm space-y-2">
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-green-600">مراكز إعادة التدوير:</strong> <span className="text-foreground/80">Green Algeria (وهران)، Recyclage Plus (قسنطينة)، مراكز النفايات في البلديات</span></div>
                        </div>
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-green-600">مبادرات محلية:</strong> <span className="text-foreground/80">جمعية "نظافة الجزائر"، حملات تنظيف الشواطئ، برامج المدارس البيئية</span></div>
                        </div>
                        <div className="text-muted-foreground text-center mt-3 pt-2 border-t border-green-200" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          🌍 كل جهد صغير يساهم في بيئة أنظف للأجيال القادمة
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="lg:order-2">
                <div className="flex items-center mb-4">
                  <div className="text-4xl mr-4">🌱</div>
                  <h3 className="font-mono text-2xl font-bold">ENVIRONMENTAL AWARENESS & WASTE MANAGEMENT</h3>
                </div>
                <p className="text-lg text-muted-foreground mb-6">
                  Learn about environmental protection, proper waste disposal, and sustainable living practices. Get guidance on recycling, reducing pollution, and contributing to a cleaner Algeria.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-green-500 rounded-full mr-3"></span>
                    <strong>Proper waste disposal and recycling centers</strong>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-green-500 rounded-full mr-3"></span>
                    <strong>Environmental impact awareness and education</strong>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-green-500 rounded-full mr-3"></span>
                    <strong>Sustainable living tips and eco-friendly alternatives</strong>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-green-500 rounded-full mr-3"></span>
                    <strong>Local environmental initiatives and community programs</strong>
                  </div>
                </div>
                <div className="mt-4 p-3 bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg">
                  <p className="text-xs text-green-700 dark:text-green-300">
                    <strong>🌿 Clean Algeria Initiative:</strong> Supporting environmental sustainability and responsible waste management across all 58 wilayas.
                  </p>
                </div>
              </div>
            </div>

            {/* 2.8. Women's Safety & Support Services - Left Description, Right Demo */}
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-4">
                  <div className="text-4xl mr-4">🛡️</div>
                  <h3 className="font-mono text-2xl font-bold">WOMEN'S SAFETY & SUPPORT SERVICES</h3>
                </div>
                <p className="text-lg text-muted-foreground mb-6">
                  Access confidential support services for women facing violence or difficult situations. Get information about legal rights, psychological support, and emergency resources available in Algeria.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-red-500 rounded-full mr-3"></span>
                    <strong>Emergency hotlines and crisis intervention</strong>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-red-500 rounded-full mr-3"></span>
                    <strong>Legal rights information and support</strong>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-red-500 rounded-full mr-3"></span>
                    <strong>Psychological and social support services</strong>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="w-2 h-2 bg-red-500 rounded-full mr-3"></span>
                    <strong>Safe shelter and protection resources</strong>
                  </div>
                </div>
                <div className="mt-4 p-3 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg">
                  <p className="text-xs text-red-700 dark:text-red-300">
                    <strong>🚨 Confidential & Safe:</strong> All conversations are private and secure. Your safety is our priority.
                  </p>
                </div>
              </div>
              <div className="bg-muted border-2 border-red-600 rounded-lg overflow-hidden">
                <div className="bg-red-600 text-white p-3 font-mono font-bold text-sm">
                  شريكي CHRIKI - Women's Safety Support (Confidential)
                </div>
                <div className="p-4 space-y-3">
                  <div className="flex justify-end">
                    <div className="bg-red-600 text-white p-3 rounded-lg max-w-xs shadow-md">
                      <div className="text-sm font-medium" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif', lineHeight: '1.5'}}>
                        محتاجة مساعدة، وين نلقى دعم للنساء اللي يتعرضو للعنف؟
                      </div>
                    </div>
                  </div>
                  <div className="flex justify-start">
                    <div className="bg-background border border-red-200 p-3 rounded-lg max-w-xs shadow-md">
                      <div className="text-sm space-y-2">
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-red-600">الرقم الأخضر الطوارئ:</strong> <span className="text-foreground/80">وزارة التضامن الوطني والأسرة وقضايا المرأة - مخصص للإبلاغ عن حالات العنف ضد المرأة</span></div>
                        </div>
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-red-600">الدعم المتوفر:</strong> <span className="text-foreground/80">دعم نفسي واجتماعي وقانوني عبر فريق متخصص. المكالمة مجانية وسرية تماماً</span></div>
                        </div>
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-red-600">خدمات إضافية:</strong> <span className="text-foreground/80">مراكز الإيواء الآمنة، المساعدة القانونية، التوجيه للخدمات الطبية</span></div>
                        </div>
                        <div className="bg-red-50 dark:bg-red-950/20 p-2 rounded text-center mt-3">
                          <div className="text-xs text-red-700 dark:text-red-300 font-bold" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                            🚨 خط الطوارئ: 15-48 | متوفر 24/7 مجاناً وبسرية تامة
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex justify-end">
                    <div className="bg-red-600 text-white p-3 rounded-lg max-w-xs shadow-md">
                      <div className="text-sm font-medium" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif', lineHeight: '1.5'}}>
                        واش كاين مراكز أخرى تقدم مساعدة؟
                      </div>
                    </div>
                  </div>
                  <div className="flex justify-start">
                    <div className="bg-background border border-red-200 p-3 rounded-lg max-w-xs shadow-md">
                      <div className="text-sm space-y-2">
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-red-600">مراكز الاستماع:</strong> <span className="text-foreground/80">مراكز الاستماع والتوجيه للنساء ضحايا العنف في كل ولاية</span></div>
                        </div>
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-red-600">الجمعيات النسائية:</strong> <span className="text-foreground/80">جمعية "فم الصبر"، "نساء في محنة"، مراكز الدعم المحلية</span></div>
                        </div>
                        <div className="flex items-start gap-2" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          <div><strong className="text-red-600">الخدمات القانونية:</strong> <span className="text-foreground/80">محامون متطوعون، مساعدة قضائية مجانية، إرشاد حول الحقوق القانونية</span></div>
                        </div>
                        <div className="text-muted-foreground text-center mt-3 pt-2 border-t border-red-200" dir="rtl" style={{fontFamily: 'system-ui, -apple-system, sans-serif'}}>
                          💪 إنت قوية ولك الحق في الحماية والدعم. لا تترددي في طلب المساعدة
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-emerald-50 border-t-4 border-green-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Revenue Streams - 4x2 Grid */}
          <div className="mb-16">
            <h3 className="font-mono text-2xl font-bold mb-8 text-green-800 text-center">{t.sections.revenueStreams}</h3>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                {
                  icon: "💰",
                  title: t.sections.sustainableGrowth,
                  description: t.sections.sustainableGrowthDesc,
                  examples: ["Free core services", "Premium features", "Enterprise solutions"]
                },
                {
                  icon: "📊",
                  title: "Analytics & Insights",
                  description: "Data-driven insights for partners and improved user experience",
                  examples: ["Usage analytics", "Performance metrics", "User feedback"]
                },
                {
                  icon: "🔒",
                  title: "Privacy-First Revenue",
                  description: "Monetization that respects user privacy and data sovereignty",
                  examples: ["Anonymous analytics", "Local data processing", "Transparent policies"]
                },
                {
                  icon: "🌍",
                  title: "Local Ecosystem Growth",
                  description: "Supporting Algerian businesses and economic development",
                  examples: ["Local partnerships", "SME support", "Digital transformation"]
                }
              ].map((stream, index) => (
                <div key={index} className="bg-white border-2 border-green-200 rounded-lg p-4 shadow-lg hover:shadow-xl transition-shadow">
                  <div className="text-center">
                    <div className="text-3xl mb-3">{stream.icon}</div>
                    <h4 className="font-mono font-bold text-sm mb-2 text-green-800">{stream.title}</h4>
                    <p className="text-green-700 text-xs mb-3 leading-relaxed">{stream.description}</p>
                    <div className="flex flex-wrap gap-1 justify-center">
                      {stream.examples.map((example, i) => (
                        <span key={i} className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs font-mono">
                          {example}
                        </span>
                      ))}
                    </div>
